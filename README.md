...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-night-8329
```

A live public deployment of this template is available at [https://rapid-night-8329.templates.workers.dev](https://rapid-night-8329.templates.workers.dev)
